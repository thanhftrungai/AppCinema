  ...
  return (
    ...
    >
      ...
      <div className="w-[92%] max-w-md p-6 md:p-8 bg-gray-900/70 backdrop-blur-xl flex-col flex items-center gap-4 rounded-2xl border border-white/10 shadow-2xl">
        ...
        <button className="w-full p-3 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl mt-3 hover:from-blue-600 hover:to-indigo-700 text-sm md:text-base font-semibold shadow-lg shadow-blue-900/30">
          Login
        </button>
